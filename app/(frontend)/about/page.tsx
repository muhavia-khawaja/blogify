...
export async function generateMetadata(): Promise<Metadata> {
  return buildMetadata({
    title: 'About',
    description:
      'Learn more about Blogify and the editorial mission behind the archive.',
    path: '/about',
    type: 'website',
  })
}
          ...
          <div className='grid gap-20 lg:grid-cols-2 lg:items-start'>
            <div>
              ...
              <p className='text-xl font-serif italic text-gray-500 leading-relaxed mb-12'>
                Blogify is more than a repository; it is a curated ecosystem
                designed for the next generation of Pakistani scholars,
              ...
              <div className='space-y-10'>
                ...
                <div className='flex items-start gap-6 group'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-500 leading-relaxed font-serif'>
                      The Archive is a living entity. We update existing
                      resources and deploy new pedagogical tools every week to
